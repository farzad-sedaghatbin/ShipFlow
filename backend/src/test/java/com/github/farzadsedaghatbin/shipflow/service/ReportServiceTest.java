...
class ReportServiceTest {
    ...
    class EnhancedCycleReportTests {
        ...
        void shouldGenerateEnhancedReport() {
            ...
            TeamAssignment assignment1 = TeamAssignment.builder()
                    .person(person1)
                    .team(team)
            ...
            // Verify hours and efficiency (pitch1: 40h appetite, 35h actual; pitch2: 24h, 30h; pitch3: 32h, 0h)
    ...
    class VarianceAnalysisTests {
        ...
        void shouldCalculatePositiveVariance() {
            ...
            List<WorkLog> pitch2Logs = workLogs.stream()
                    .filter(wl -> wl.getPitch().getId().equals(2L))
                    .toList();
        ...
        void shouldCalculateNegativeVariance() {
            ...
            List<WorkLog> pitch1Logs = workLogs.stream()
                    .filter(wl -> wl.getPitch().getId().equals(1L))
                    .toList();
