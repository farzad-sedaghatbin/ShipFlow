...
/**
 * Unit tests for GitHubAppOAuthService
 * Tests OAuth flow, installation management, and bulk repository sync
 */
...
class GitHubAppOAuthServiceTest {
    ...
    void setUp() {
        ...
        service = new GitHubAppOAuthService(
    ...
    void isAppConfigured_withAllConfig_returnsTrue() {
        ...
        ReflectionTestUtils.setField(service, "privateKey", "-----BEGIN RSA PRIVATE KEY-----\ntest\n-----END RSA PRIVATE KEY-----");
    ...
    void getConfigurationStatus_returnsCorrectStatus() {
        ...
        when(installationRepository.findByIsActiveTrue()).thenReturn(Arrays.asList(
                createTestInstallation(1L, "org1", "Organization")
        ));
