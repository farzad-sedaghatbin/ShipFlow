...
/**
 * Integration tests for OrganizationSettingsController. Tests cover: - Authentication and
 * authorization - GET, PUT, POST endpoints - Request validation - Response formats - Database
 * persistence
 */
@SpringBootTest
...
class OrganizationSettingsControllerIntegrationTest {
  ...
  void getSettings_NoExisting_ShouldReturnDefaults() throws Exception {
    mockMvc
        ...
        .andExpect(jsonPath("$.pitchCategories", hasSize(4)))
  ...
  void getSettings_Existing_ShouldReturnSettings() throws Exception {
    ...
    OrganizationSettings existing =
        OrganizationSettings.builder()
            ...
            .riskThresholdsJson("{\"lowMax\":25,\"mediumMax\":55,\"highMax\":80}")
            .taskCategoriesJson("[]")
            .pitchCategoriesJson("[]")
  ...
  void updateSettings_TaskCategories_ShouldUpdate() throws Exception {
    // Given
    List<OrganizationSettingsDTO.CategoryConfig> categories =
        List.of(
    ...
    UpdateOrganizationSettingsRequest request =
        UpdateOrganizationSettingsRequest.builder().taskCategories(categories).build();
  ...
  void updateSettings_PartialUpdate_ShouldUpdateOnlyProvidedFields() throws Exception {
    ...
    UpdateOrganizationSettingsRequest initial =
        UpdateOrganizationSettingsRequest.builder()
    ...
    UpdateOrganizationSettingsRequest partial =
        UpdateOrganizationSettingsRequest.builder().organizationName("Partial Update").build();
  ...
  void resetSettings_ShouldResetToDefaults() throws Exception {
    ...
    UpdateOrganizationSettingsRequest custom =
        UpdateOrganizationSettingsRequest.builder()
    ...
    mockMvc
        .perform(post("/api/admin/settings/reset"))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.organizationName", is("My Organization")))
        .andExpect(jsonPath("$.defaultCycleLengthWeeks", is(6)))
        .andExpect(jsonPath("$.defaultCooldownWeeks", is(2)))
  ...
  void fullLifecycle_CreateUpdateReset_ShouldWork() throws Exception {
    ...
    // 2. Update settings
    UpdateOrganizationSettingsRequest update =
        UpdateOrganizationSettingsRequest.builder()
