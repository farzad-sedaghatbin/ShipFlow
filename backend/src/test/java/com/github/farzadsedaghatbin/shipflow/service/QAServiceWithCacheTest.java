...
/**
 * Tests for QAService with caching integration.
 * Tests cover:
 * - Cache hit scenarios
...
class QAServiceWithCacheTest {
    ...
    class QACacheHitTests {
        ...
        void shouldReturnCachedResponseForExactQuestion() {
            ...
            QAResponse cachedResponse = QAResponse.builder()
                    .question(question)
            ...
            // When
            Optional<QAResponse> result = cacheService.getCachedQAResponse(
                    question, "pitch", 1L, null, null);
        ...
        void shouldReturnCachedResponseForFuzzyMatch() {
            ...
            // When
            Optional<QAResponse> result = cacheService.getCachedQAResponse(
                    similarQuestion, "pitch", 1L, null, null);
        ...
        void shouldNotReturnCachedResponseForDifferentQuestion() {
            ...
            // When
            Optional<QAResponse> result = cacheService.getCachedQAResponse(
                    differentQuestion, "pitch", 1L, null, null);
    ...
    class QACacheContextTests {
        ...
        void shouldIsolateCacheByPitchContext() {
            ...
            QAResponse pitch1Response = QAResponse.builder()
                    .question(question)
            ...
            QAResponse pitch2Response = QAResponse.builder()
                    .question(question)
        ...
        void shouldIsolateCacheByCycleContext() {
            ...
            QAResponse cycle1Response = QAResponse.builder()
                    .question(question)
