...
class RetroControllerIntegrationTest {
    ...
    void setUp() {
        ...
        testCycle = cycleRepository.save(Cycle.builder()
                .name("Test Cycle")
                .project(testProject)
    ...
    class RetroCrudTests {
        ...
        void getRetroByIdSucceeds() throws Exception {
            Retrospective retro = retroRepository.save(Retrospective.builder()
                    .title("Test Retro")
            ...
            mockMvc.perform(get("/api/retros/" + retro.getId()))
        ...
        void getRetrosByProjectSucceeds() throws Exception {
            retroRepository.save(Retrospective.builder()
                    .title("Retro 1")
                    .status(RetroStatus.DRAFT)
                    .cycle(testCycle)
                    .project(testProject)
        ...
        void updateRetroSucceeds() throws Exception {
            ...
            UpdateRetroRequest updateRequest = UpdateRetroRequest.builder()
                    .title("Updated Title")
                    .notes("Updated notes")
                    .build();

            mockMvc.perform(put("/api/retros/" + retro.getId())
                            .contentType(MediaType.APPLICATION_JSON)
        ...
        void deleteRetroSucceeds() throws Exception {
            ...
            mockMvc.perform(delete("/api/retros/" + retro.getId()))
    ...
    class RetroStatusTests {
        ...
        void openRetroSucceeds() throws Exception {
            ...
            mockMvc.perform(post("/api/retros/" + retro.getId() + "/open"))
                    .andExpect(status().isOk())
        ...
        void closeRetroSucceeds() throws Exception {
            ...
            mockMvc.perform(post("/api/retros/" + retro.getId() + "/close"))
                    .andExpect(status().isOk())
    ...
    class RetroItemTests {
        ...
        @BeforeEach
        void setUpRetro() {
            openRetro = retroRepository.save(Retrospective.builder()
                    .title("Open Retro")
                    .status(RetroStatus.OPEN)
                    .cycle(testCycle)
                    .project(testProject)
        ...
        void getItemsSucceeds() throws Exception {
            ...
            mockMvc.perform(get("/api/retros/" + openRetro.getId() + "/items"))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$", hasSize(2)));
        }
        ...
        void updateItemSucceeds() throws Exception {
            RetroItem item = retroItemRepository.save(RetroItem.builder()
                    .content("Original")
            ...
            mockMvc.perform(put("/api/retros/items/" + item.getId())
                            .contentType(MediaType.APPLICATION_JSON)
        ...
        void deleteItemSucceeds() throws Exception {
            ...
            mockMvc.perform(delete("/api/retros/items/" + item.getId()))
                    .andExpect(status().isNoContent());
        }
    ...
    class CycleRetroStatusTests {
        ...
        void getCycleStatusNoRetros() throws Exception {
            mockMvc.perform(get("/api/retros/cycle/" + testCycle.getId() + "/status"))
                    .andExpect(status().isOk())
        ...
        void canCloseCycleEndpoint() throws Exception {
            ...
            mockMvc.perform(get("/api/retros/cycle/" + testCycle.getId() + "/can-close"))
                    .andExpect(status().isOk())
    ...
    class ProjectSettingTests {
        ...
        void checkRetrosEnabled() throws Exception {
            mockMvc.perform(get("/api/retros/project/" + testProject.getId() + "/enabled"))
                    .andExpect(status().isOk())
