...
class CustomDashboardServiceTest {
    ...
    void setUp() {
        ...
        testDashboard = CustomDashboard.builder()
                .id(1L)
                .user(testUser)
                .name("Test Dashboard")
    ...
    class ScopeFeatureTests {
        ...
        void shouldCreateDashboardWithCycleScope() {
            ...
            verify(customDashboardRepository).save(argThat(dashboard -> 
    ...
    class UserContextFilterTests {
        ...
        void shouldToggleFilterFromFalseToTrue() {
            ...
            verify(customDashboardRepository).save(argThat(dashboard -> 
                dashboard.getUserContextFilter() != null && dashboard.getUserContextFilter()
            ));
        }
