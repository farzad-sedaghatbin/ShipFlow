...
/**
 * Unit tests for GitHubIntegrationService Tests pattern matching, auto-linking, and auto-closing
 * functionality
 */
@ExtendWith(MockitoExtension.class)
class GitHubIntegrationServiceTest {

  @Mock private GitHubRepositoryRepository githubRepoRepository;

  @Mock private GitHubCommitRepository commitRepository;

  @Mock private GitHubPullRequestRepository pullRequestRepository;

  @Mock private TaskGitHubLinkRepository taskLinkRepository;

  @Mock private PitchGitHubLinkRepository pitchLinkRepository;

  @Mock private GitHubConfigurationRepository configurationRepository;

  @Mock private TaskRepository taskRepository;

  @Mock private PitchRepository pitchRepository;

  @InjectMocks private GitHubIntegrationService service;
  ...
  void processCommit_WithTraditionalStyleReference_ShouldAutoLinkToTask() {
    ...
    assertThat(result).isNotNull();
    verify(taskLinkRepository)
        .save(argThat(link -> link.getTask().getId().equals(42L) && link.getAutoLinked()));
  }
  ...
  void processCommit_WhenExistingCommit_ShouldReturnExisting() {
    ...
    GitHubCommit result =
        service.processCommit(
            ...
            LocalDateTime.now(),
            "main",
            "https://github.com/test/commit/abc123");
