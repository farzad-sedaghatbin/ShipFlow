...
/**
 * Unit tests for PitchHealthService configurable thresholds feature.
 * Tests that organization settings properly override default thresholds.
 */
...
class PitchHealthServiceConfigurableThresholdsTest {
    ...
    void shouldUseCustomBudgetThresholds() {
        ...
        OrganizationSettingsDTO settings = OrganizationSettingsDTO.builder()
    ...
    void shouldUseCustomTimeThresholds() {
        ...
        LocalDate today = LocalDate.now();
        Cycle urgentCycle = Cycle.builder()
                .id(2L)
                .name("Urgent Cycle")
        ...
        Pitch urgentPitch = Pitch.builder()
                .id(2L)
                .title("Urgent Pitch")
                .appetiteDays(10)
                .cycle(urgentCycle)
