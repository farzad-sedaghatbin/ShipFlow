...
/**
 * Unit tests for PitchRiskHistory entity and repository interactions.
 * Tests cover:
 * - Risk history retrieval with date filtering
 * - Risk factor serialization
...
class PitchRiskHistoryTest {
    ...
    class RepositoryTests {
        ...
        void shouldFindHistoryByPitchIdAndDateRange() {
            ...
            // When
            List<PitchRiskHistory> result = riskHistoryRepository.findByPitchIdAndDateRange(
    ...
    class EntityTests {
        ...
        void shouldCreateHistoryWithAllFields() {
            ...
            PitchRiskHistory history = PitchRiskHistory.builder()
                    ...
                    .riskFactorsJson("[{\"category\":\"TIME_OVERRUN\",\"description\":\"Behind schedule\"}]")
                    .build();
    ...
    class RiskLevelTests {
        ...
        void shouldHaveAllExpectedRiskLevels() {
            ...
            assertThat(RiskLevel.values()).containsExactlyInAnyOrder(
                    RiskLevel.LOW,
                    RiskLevel.MEDIUM,
                    RiskLevel.HIGH,
                    RiskLevel.CRITICAL
