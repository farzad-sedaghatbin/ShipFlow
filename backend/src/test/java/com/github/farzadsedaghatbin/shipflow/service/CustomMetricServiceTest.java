...
class CustomMetricServiceTest {
  ...
  @Mock private CustomMetricRepository customMetricRepository;

  @Mock private MetricDataPointRepository metricDataPointRepository;
  ...
  @Mock private MetricFormulaParser formulaParser;

  @Mock private TeamRepository teamRepository;

  @Mock private MessageService messageService;

  @InjectMocks private CustomMetricService customMetricService;
  ...
  class CreateMetricTests {
    ...
    void shouldCreateMetric() {
      ...
      when(customMetricRepository.save(any(CustomMetric.class)))
          .thenAnswer(
              invocation -> {
    ...
    void shouldThrowExceptionForInvalidFormula() {
      ...
      IllegalArgumentException exception =
          assertThrows(
              IllegalArgumentException.class, () -> customMetricService.createMetric(1L, request));
    ...
    void shouldThrowExceptionWhenUserNotFound() {
      ...
      // Act & Assert
      assertThrows(
          IllegalArgumentException.class, () -> customMetricService.createMetric(999L, request));
    }
  }
  ...
  class UpdateMetricTests {
    ...
    void shouldThrowExceptionWhenNotAuthorized() {
      ...
      SecurityException exception =
          assertThrows(
              SecurityException.class, () -> customMetricService.updateMetric(999L, 1L, request));
  ...
  class DeleteMetricTests {
    ...
    void shouldThrowExceptionWhenDeletingNonExistentMetric() {
      ...
      // Act & Assert
      assertThrows(
          IllegalArgumentException.class, () -> customMetricService.deleteMetric(1L, 999L));
    }
  ...
  class GetMetricTests {
    ...
    void shouldGetAllMetricsForUser() {
      ...
      when(customMetricRepository.findByUserIdOrderByNameAsc(1L))
          .thenReturn(Arrays.asList(testMetric, metric2));
  ...
  class CalculateMetricTests {
    ...
    void shouldThrowExceptionWhenCalculatingNonExistentMetric() {
      ...
      // Act & Assert
      assertThrows(
          IllegalArgumentException.class, () -> customMetricService.calculateMetricValue(1L, 999L));
    }
    ...
    void shouldThrowExceptionWhenNotAuthorizedToCalculate() {
      ...
      // Act & Assert
      assertThrows(
          SecurityException.class, () -> customMetricService.calculateMetricValue(999L, 1L));
    }
  }
  ...
  class ScopeFeatureTests {
    ...
    void shouldCreateMetricWithCycleScope() {
      ...
      verify(customMetricRepository)
          .save(
              argThat(
                  metric -> metric.getCycle() != null && metric.getCycle().getId().equals(10L)));
    }
    ...
    void shouldCreateMetricWithPitchScope() {
      ...
      verify(customMetricRepository)
          .save(
              argThat(
                  metric -> metric.getPitch() != null && metric.getPitch().getId().equals(20L)));
    }
    ...
    void shouldCreateMetricWithTeamScope() {
      ...
      verify(customMetricRepository)
          .save(
              argThat(metric -> metric.getTeam() != null && metric.getTeam().getId().equals(30L)));
    }
    ...
    void shouldCreateMetricWithMultipleScopes() {
      ...
      when(formulaParser.validateFormula(anyString())).thenReturn(ValidationResult.success());
      when(customMetricRepository.existsByUserIdAndName(1L, "Multi-Scope Metric"))
          .thenReturn(false);
      when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
      when(cycleRepository.findById(10L)).thenReturn(Optional.of(testCycle));
      when(pitchRepository.findById(20L)).thenReturn(Optional.of(testPitch));
    ...
    void shouldThrowExceptionForInvalidCycleId() {
      ...
      when(formulaParser.validateFormula(anyString())).thenReturn(ValidationResult.success());
      when(customMetricRepository.existsByUserIdAndName(1L, "Invalid Cycle Metric"))
          .thenReturn(false);
      when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
    ...
    void shouldThrowExceptionForInvalidPitchId() {
      ...
      when(formulaParser.validateFormula(anyString())).thenReturn(ValidationResult.success());
      when(customMetricRepository.existsByUserIdAndName(1L, "Invalid Pitch Metric"))
          .thenReturn(false);
      when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
    ...
    void shouldThrowExceptionForInvalidTeamId() {
      ...
      when(formulaParser.validateFormula(anyString())).thenReturn(ValidationResult.success());
      when(customMetricRepository.existsByUserIdAndName(1L, "Invalid Team Metric"))
          .thenReturn(false);
      when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
