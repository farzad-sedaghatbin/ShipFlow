...
class AICacheControllerIntegrationTest {
  ...
  void clearAllCaches_ShouldClearCaches() throws Exception {
    ...
    // Then
    mockMvc.perform(get("/api/cache/stats")).andExpect(jsonPath("$.totalEntries", is(0)));
  }
  ...
  void clearRiskCache_ShouldClearRiskCache() throws Exception {
    ...
    // Then
    mockMvc.perform(get("/api/cache/stats")).andExpect(jsonPath("$.pitchRiskEntries", is(0)));
  }
  ...
  void clearQACache_ShouldClearQACache() throws Exception {
    ...
    // Then
    mockMvc.perform(get("/api/cache/stats")).andExpect(jsonPath("$.qaEntries", is(0)));
  }
