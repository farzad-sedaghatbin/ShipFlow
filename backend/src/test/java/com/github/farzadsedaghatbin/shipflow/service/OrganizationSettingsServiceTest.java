 ...
 * Tests cover:
 * - Retrieving settings (existing and default creation)
 * - Updating settings (full and partial updates)
...
class OrganizationSettingsServiceTest {
    ...
    void setUp() {
        ...
        testSettings = OrganizationSettings.builder()
                ...
                .taskCategoriesJson("[{\"name\":\"PITCH_SCOPE\",\"description\":\"Pitch work\",\"color\":\"#3B82F6\",\"isActive\":true,\"order\":1}]")
                .pitchCategoriesJson("[{\"name\":\"FEATURE\",\"description\":\"New features\",\"color\":\"#10B981\",\"isActive\":true,\"order\":1}]")
                .timeZone("UTC")
    ...
    class UpdateSettingsTests {
        ...
        void shouldUpdateTaskCategories() {
            ...
            List<OrganizationSettingsDTO.CategoryConfig> newCategories = List.of(
