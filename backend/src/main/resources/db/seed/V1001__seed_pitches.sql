...
(1, 'GitHub Integration', 'Integrate with GitHub for issue tracking and PR linking', 14, 4, 1, 'IN_PROGRESS', '2025-10-15', CURRENT_TIMESTAMP),
(2, 'Slack Notifications', 'Send real-time notifications to Slack channels', 7, 4, 1, 'IN_PROGRESS', '2025-10-15', CURRENT_TIMESTAMP),
-- Beta Team pitches
(3, 'Dashboard Widgets', 'Customizable dashboard with drag-drop widgets', 14, 4, 2, 'IN_PROGRESS', '2025-10-15', CURRENT_TIMESTAMP),
(4, 'User Preferences', 'Theme settings, notifications, and display preferences', 7, 4, 2, 'DONE', '2025-10-15', CURRENT_TIMESTAMP);

-- ===========================================
-- SHAPED pitches for Cycle 5 (ready for betting)
-- ===========================================
INSERT INTO pitches (id, title, description, appetite_days, cycle_id, team_id, status, created_at, updated_at) OVERRIDING SYSTEM VALUE VALUES
(5, 'Mobile Offline Mode', 'Enable offline data caching and sync', 14, 5, NULL, 'SHAPED', '2025-11-01', CURRENT_TIMESTAMP),
(6, 'Push Notifications', 'Mobile push notifications for key events', 7, 5, NULL, 'SHAPED', '2025-11-01', CURRENT_TIMESTAMP),
(7, 'Biometric Login', 'Face ID and fingerprint authentication', 7, 5, NULL, 'SHAPED', '2025-11-01', CURRENT_TIMESTAMP),
(8, 'Activity Timeline', 'Show user activity history with detailed timeline', 10, 5, NULL, 'SHAPED', '2025-11-01', CURRENT_TIMESTAMP),
(9, 'Two-Factor Auth', 'Add 2FA support with TOTP apps', 14, 5, NULL, 'SHAPED', '2025-11-02', CURRENT_TIMESTAMP),
...
-- ===========================================
INSERT INTO pitches (id, title, description, appetite_days, cycle_id, team_id, status, created_at, updated_at) OVERRIDING SYSTEM VALUE VALUES
(14, 'User Authentication', 'Login, registration, and password reset', 14, 1, NULL, 'DONE', '2025-06-01', '2025-07-10'),
(15, 'Project Management', 'Create and manage projects', 7, 1, NULL, 'DONE', '2025-06-01', '2025-07-08'),
(16, 'Hill Chart Tracking', 'Visual progress tracking with hill charts', 14, 2, NULL, 'DONE', '2025-07-15', '2025-08-20'),
(17, 'Cycle Management', 'Create and manage Shape Up cycles', 10, 2, NULL, 'DONE', '2025-07-15', '2025-08-22'),
(18, 'Retrospectives', 'End-of-cycle retrospective boards', 7, 3, NULL, 'DONE', '2025-09-01', '2025-09-28'),
