...
public class LLMCacheService {
    ...
    /**
     * Initialize Redis connection for distributed LLM cache.
    ...
    private void evictOldestEntries() {
        ...
        // Evict approximately 27.5% of current size (to leave ~72.5% of maxCacheSize after continued additions)
    ...
    public CacheStats getStats() {
        int totalHits = cache.values().stream()
                .mapToInt(CachedResponse::getHitCount)
                .sum();
