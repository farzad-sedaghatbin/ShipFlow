...
public class PitchService {
  ...
  /**
   * Get pitches that the current user has access to. ADMINs can see all pitches, other users see
   * only pitches from accessible projects.
   */
  public List<PitchDTO> getAccessiblePitches() {
    ...
    return pitchRepository.findAccessiblePitchesByUserId(currentUser.getId()).stream()
        .map(this::toDTO)
