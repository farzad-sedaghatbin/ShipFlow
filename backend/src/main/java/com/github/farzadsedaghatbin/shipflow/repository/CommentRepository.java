...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    List<Comment> findByEntityTypeAndEntityIdNotDeleted(
            @Param("entityType") CommentEntityType entityType,
    ...
    Page<Comment> findByEntityTypeAndEntityIdNotDeleted(
            @Param("entityType") CommentEntityType entityType,
            @Param("entityId") Long entityId,
            Pageable pageable);
    ...
    long countByEntityTypeAndEntityIdNotDeleted(
            @Param("entityType") CommentEntityType entityType,
            @Param("entityId") Long entityId);
    ...
    boolean existsByEntityTypeAndEntityIdNotDeleted(
            @Param("entityType") CommentEntityType entityType,
            @Param("entityId") Long entityId);
}
