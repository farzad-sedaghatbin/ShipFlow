 ...
 * 
 * Examples:
 * - "Compare payment feature risks vs checkout redesign" 
 *   → ["What are the risks for payment feature?", "What are the risks for checkout redesign?"]
 * - "Which team is faster on backend work?"
 *   → ["What teams work on backend?", "What is the velocity of each team?"]
 */
@Slf4j
@Component
