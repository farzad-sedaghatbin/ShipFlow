...
/**
 * Entity representing dashboard notifications for users.
 * Tracks overdue tasks, blocked scopes, cycle deadlines, and other important events.
 */
@Entity
@Table(name = "dashboard_notifications", indexes = {
