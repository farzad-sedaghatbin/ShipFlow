 ...
 * 
 * This service uses LLM to analyze pitch documents and extract:
 * - Problem Statement: What problem is being solved
 * - Solution: The proposed solution (hatched solution / fat-marker sketches)
 * - Rabbit Holes: Edge cases and areas to avoid
 * - Risks: Known risks and unknowns
 * - No-Gos: Things explicitly out of scope
 * - Wireframe/Prototype links: Visual references
 */
@Service
@Slf4j
...
public class PitchShapingExtractorService {
    ...
    /**
     * Extract pitch data from multiple document texts.
     * Combines content from all documents before extraction.
     */
