...
/**
 * Service for parsing and evaluating custom metric formulas.
 * Supports:
 * - Mathematical operations: +, -, *, /, (, )
 * - Functions: SUM, AVG, COUNT, MIN, MAX
 * - Field references: pitch.appetiteDays, workLog.hours, etc.
...
public class MetricFormulaParser {
     ...
     * @param dataContext Map containing aggregated data (e.g., {"totalPitches": 10, "completedPitches": 8})
    ...
    private boolean isValidFieldReference(String entity, String field) {
        ...
        Map<String, List<String>> validFields = Map.of(
