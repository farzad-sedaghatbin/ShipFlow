...
/**
 * Entity representing a user-defined custom metric.
 * Supports formula-based calculations for deriving insights from various data sources.
 */
@Entity
@Table(name = "custom_metrics", uniqueConstraints = {
...
public class CustomMetric {
    ...
    /**
     * Formula for calculating the metric value.
     * Examples:
     * - "COUNT(pitch WHERE status=DONE)"
    ...
    /**
     * JSON filters to apply when calculating the metric
     * Example: {"cycleId": 1, "teamIds": [1,2], "dateRange": {"start": "2026-01-01", "end": "2026-01-31"}}
     */
