 ...
 * Provides endpoints for creating, deleting, and querying task dependencies.
 */
@RestController
...
public class TaskDependencyController {
    ...
    @Operation(summary = "Add a task dependency", 
               description = "Create a dependency between the specified task and another task. Validates against circular dependencies.")
    ...
    @GetMapping("/blocking")
    @Operation(summary = "Get tasks this task is blocking",
