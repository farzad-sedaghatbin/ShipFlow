...
public class TeamService {
  ...
  public List<TeamDTO> getAllTeams() {
    return teamRepository.findAllWithAssignments().stream()
        .map(this::toDTO)
  ...
  private TeamDTO toDTO(Team team) {
    List<TeamAssignmentDTO> assignmentDTOs =
        team.getAssignments() != null
    ...
    return TeamDTO.builder()
        ...
        .projectId(
            team.getCycle() != null && team.getCycle().getProject() != null
