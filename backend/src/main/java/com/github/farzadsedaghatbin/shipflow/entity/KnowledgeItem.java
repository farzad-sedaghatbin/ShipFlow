 ...
 * Knowledge is extracted from various sources: pitches, meetings, worklogs, notes, etc.
 */
@Entity
...
public class KnowledgeItem {
    ...
    /**
     * Unique identifier for the embedding in the vector store.
     * Used to link this DB record with the vector store entry.
     */
    @Column(length = 100)
