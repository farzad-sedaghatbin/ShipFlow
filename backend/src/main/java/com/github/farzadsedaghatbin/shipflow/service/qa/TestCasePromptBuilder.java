...
public class TestCasePromptBuilder {
  ...
  public String buildPrompt(Pitch pitch, String context, GenerateTestCasesRequest request,
      List<EmbeddingMatch<TextSegment>> historicalTests, TestType testType) {
  ...
  private String buildSmokeTestPrompt(Pitch pitch, String context, GenerateTestCasesRequest request,
  ...
  private String buildFunctionalTestPrompt(Pitch pitch, String context, GenerateTestCasesRequest request,
      List<EmbeddingMatch<TextSegment>> historicalTests) {
  ...
  private String buildRegressionTestPrompt(Pitch pitch, String context, GenerateTestCasesRequest request,
      List<EmbeddingMatch<TextSegment>> historicalTests) {
  ...
  private String buildIntegrationTestPrompt(Pitch pitch, String context, GenerateTestCasesRequest request) {
  ...
  private String buildE2ETestPrompt(Pitch pitch, String context, GenerateTestCasesRequest request) {
  ...
  private String buildGenericPrompt(Pitch pitch, String context, GenerateTestCasesRequest request) {
  ...
  private String formatHistoricalExamples(List<EmbeddingMatch<TextSegment>> historicalTests) {
    ...
    return historicalTests.stream().limit(3) // Show only top 3 examples
        .map(match -> {
  ...
  private String extractPastFailures(GenerateTestCasesRequest request) {
    ...
    if (request.getAdditionalContext() != null && request.getAdditionalContext().toLowerCase().contains("fail")) {
