...
public class DashboardWidgetConfig {
    ...
    /**
     * Data filtering configuration (JSON)
     * Example: {"teamIds": [1,2], "cycleIds": [3], "dateRange": {"start": "2026-01-01", "end": "2026-01-31"}}
     */
     ...
     * Example: {"chartType": "BAR", "colors": ["#2563eb", "#7c3aed"], "legend": {"position": "bottom"}}
     */
