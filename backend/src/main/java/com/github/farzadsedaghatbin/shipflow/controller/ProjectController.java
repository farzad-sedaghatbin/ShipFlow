...
public class ProjectController {
  ...
  @Operation(
      ...
      description = "Returns all projects. For scoped access use /my-projects")
  public ResponseEntity<List<ProjectDTO>> getAllProjects() {
    return ResponseEntity.ok(projectService.findAll());
  }

  /**
   * Get projects accessible to the current user. This is the primary endpoint for listing projects.
   */
  @GetMapping("/my-projects")
  @PreAuthorize("isAuthenticated()")
  @Operation(
      summary = "Get user's accessible projects",
      description = "Returns projects the current user has access to")
  ...
  @PreAuthorize("isAuthenticated()")
  @Operation(
      summary = "Get user's active projects",
      description = "Returns active projects the user has access to")
  ...
  @Operation(
      ...
      description = "Returns a single project by its ID (if user has access)")
  ...
  @Operation(
      ...
      description = "Returns a single project by its unique key (if user has access)")
  ...
  @Operation(
      ...
      description = "Returns true if user has access to the project")
  ...
  @Operation(
      ...
      description = "Returns users with direct access to the project")
  public ResponseEntity<List<ProjectMemberDTO>> getProjectMembers(@PathVariable Long id) {
    ...
    List<ProjectMemberDTO> dtos =
        members.stream().map(this::toMemberDTO).collect(Collectors.toList());
  ...
  @Operation(
      ...
      description = "Grant access to a user (Project Manager or Admin)")
  ...
  @Operation(
      ...
      description = "Revoke access from a user (Project Manager or Admin)")
  ...
  @Operation(
      ...
      description = "Creates a new project (Admin or Manager only)")
  ...
  @Operation(
      ...
      description = "Updates an existing project (Admin or Manager only)")
  ...
  @Operation(
      ...
      description = "Deactivates a project (Admin or Manager only)")
  ...
  @Operation(
      ...
      description = "Reactivates a previously deactivated project (Admin or Manager only)")
  ...
  @Operation(
      ...
      description = "Permanently deletes a project (Admin only). Project must have no cycles.")
  ...
  private ProjectMemberDTO toMemberDTO(UserProject up) {
    return ProjectMemberDTO.builder()
        ...
        .projectRole(up.getProjectRole())
        .grantedAt(up.getCreatedAt())
        .grantedByUsername(up.getGrantedBy() != null ? up.getGrantedBy().getUsername() : null)
        .build();
  }
