 ...
 * Contains metadata about when and who made the change, plus the list of field
 * changes.
 */
@Data
@Builder
...
public class EntityHistoryDTO {
  ...
  /**
   * The username of the user who made this change. "system" for changes made by
   * scheduled tasks or migrations.
   */
  ...
  /**
   * The list of individual field changes in this revision. Empty for DELETE
   * revisions, and for CREATE revisions, shows initial values.
   */
