...
public interface CommentReactionRepository extends JpaRepository<CommentReactionEntity, Long> {
   ...
   */
  Optional<CommentReactionEntity> findByCommentIdAndUserIdAndReactionType(Long commentId, Long userId,
      CommentReaction reactionType);

  /**
   * Check if user has a specific reaction on a comment.
   */
  boolean existsByCommentIdAndUserIdAndReactionType(Long commentId, Long userId, CommentReaction reactionType);
  ...
  long countByCommentIdAndReactionType(@Param("commentId") Long commentId,
  ...
  List<CommentReaction> findUserReactionsByCommentIdAndUserId(@Param("commentId") Long commentId,
