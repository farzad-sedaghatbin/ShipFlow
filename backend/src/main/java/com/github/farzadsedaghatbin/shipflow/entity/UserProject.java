...
/**
 * Junction entity for direct user-project assignments.
 * Users can access projects through:
 * 1. Being the project owner
 * 2. Team membership (via TeamAssignment → Team → Cycle → Project)
 * 3. Direct assignment via this entity
 * 
...
public class UserProject {
    ...
    /**
     * The role this user has within this specific project.
     * VIEWER: Read-only access to project data
     * CONTRIBUTOR: Can create/edit pitches, tasks, bugs within project
