...
public interface TestCaseRepository extends JpaRepository<TestCase, Long> {
  ...
  List<TestCase> findWithFilters(@Param("projectId") Long projectId, @Param("cycleId") Long cycleId,
      @Param("pitchId") Long pitchId, @Param("statuses") List<TestCaseStatus> statuses,
      @Param("types") List<TestCaseType> types, @Param("priorities") List<TestCasePriority> priorities,
      @Param("createdById") Long createdById, @Param("aiGenerated") Boolean aiGenerated);
