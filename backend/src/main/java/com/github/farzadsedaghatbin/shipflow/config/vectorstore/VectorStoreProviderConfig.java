...
/**
 * Configuration container for vector store providers.
 * Supports common settings and provider-specific extra parameters.
 * 
 * <p>Common settings:
 * <ul>
 *   <li>url: Base URL for the vector store service</li>
 *   <li>apiKey: API key for authentication (if required)</li>
 *   <li>collectionName: Name of the collection/index to use</li>
