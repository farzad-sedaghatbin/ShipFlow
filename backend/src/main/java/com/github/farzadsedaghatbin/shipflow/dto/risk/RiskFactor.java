...
public class RiskFactor {
  ...
  public enum RiskCategory {
    SCOPE_CREEP, TIME_OVERRUN, RESOURCE_CONSTRAINT, TECHNICAL_COMPLEXITY, DEPENDENCY_RISK, TEAM_CAPACITY, UNCLEAR_REQUIREMENTS, PROGRESS_STAGNATION, APPETITE_MISMATCH, OTHER
  }
}
