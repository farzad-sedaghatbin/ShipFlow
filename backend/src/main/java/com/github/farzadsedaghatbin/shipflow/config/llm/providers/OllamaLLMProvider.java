 ...
 * <ul>
 *   <li>Local development without API costs</li>
 *   <li>Self-hosted deployments with privacy requirements</li>
 *   <li>Running open-source models locally</li>
 * </ul>
 * 
 * <p>Configuration:
 * <ul>
 *   <li>baseUrl: Ollama API URL (default: http://localhost:11434)</li>
 *   <li>modelName: Model to use (e.g., mistral:instruct, llama2, codellama)</li>
 *   <li>timeout: Request timeout</li>
 *   <li>temperature: Model temperature (0.0-1.0)</li>
 * </ul>
 */
@Component
@Slf4j
