...
/**
 * REST controller for AI risk feedback endpoints.
 * Allows team leads to provide feedback on AI risk assessments.
 */
@RestController
...
public class RiskFeedbackController {
    ...
    @PostMapping
    @Operation(summary = "Submit risk feedback", 
    ...
    @Operation(summary = "Get feedback for pitch", 
    ...
    @Operation(summary = "Get feedback for cycle", 
    ...
    @GetMapping("/recent")
    @Operation(summary = "Get recent feedback", 
               description = "Get feedback from the last 30 days")
    ...
    @Operation(summary = "Check if user submitted feedback", 
