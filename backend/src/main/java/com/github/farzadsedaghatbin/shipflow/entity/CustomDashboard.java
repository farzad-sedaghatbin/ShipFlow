...
/**
 * Entity representing a custom dashboard configuration.
 * Users can create multiple dashboards with different widget arrangements.
 */
@Entity
@Table(name = "custom_dashboards", uniqueConstraints = {
...
public class CustomDashboard {
    ...
    /**
     * Grid layout configuration (JSON)
     * Example: {"columns": 12, "rowHeight": 60, "breakpoints": {"lg": 1200, "md": 996, "sm": 768}}
     */
    ...
    /**
     * When enabled, widgets filter data to user's context (their cycles, teams, tasks)
