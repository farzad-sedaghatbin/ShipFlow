...
public class WorkLogController {
    ...
    @GetMapping("/my")
    @Operation(summary = "Get current user's work logs", 
               description = "Returns all work logs created by the currently authenticated user. User must be linked to a Person profile.")
    @ApiResponses({
    ...
    @Operation(summary = "Get current user's work logs by cycle",
    ...
    @Operation(summary = "Get current user's work logs by date",
    ...
    @PostMapping("/my")
    @Operation(summary = "Create a work log for yourself",
               description = "Creates a new work log for the currently authenticated user. The personId is automatically set to the user's linked Person profile.")
    @ApiResponses({
    ...
    @PutMapping("/my/{id}")
    @Operation(summary = "Update your own work log",
    ...
    @DeleteMapping("/my/{id}")
    @Operation(summary = "Delete your own work log",
