...
public class CustomMetricService {
  ...
  @Transactional
  public CustomMetricDTO updateMetric(
      Long userId, Long metricId, UpdateCustomMetricRequest request) {
            ...
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        messageService.getMessage("error.metric.not.found", metricId)));
      ...
      if (!validation.isValid()) {
        throw new IllegalArgumentException(
            messageService.getMessage(
                "error.metric.formula.invalid", validation.getErrorMessage()));
      }
