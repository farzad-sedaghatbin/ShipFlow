 ...
 * Provides CRUD operations for comments on tasks and bug reports.
 */
@RestController
...
public class CommentController {
    ...
    @PreAuthorize("isAuthenticated()")
    @Operation(summary = "Get comments for entity (paginated)", 
               description = "Returns paginated comments for a task or bug report")
    ...
    @Operation(summary = "Toggle reaction", 
               description = "Adds or removes a reaction on a comment (toggle behavior)")
    public ResponseEntity<CommentDTO> toggleReaction(
            @PathVariable Long commentId,
    ...
    @PreAuthorize("isAuthenticated()")
    @Operation(summary = "Get available reactions", 
               description = "Returns list of available reaction types with emojis")
