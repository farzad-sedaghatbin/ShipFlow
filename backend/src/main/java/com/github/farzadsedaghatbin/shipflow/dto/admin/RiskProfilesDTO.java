...
/**
 * Preset risk calculation profiles for quick organization setup.
 * Provides predefined weight distributions optimized for different risk management approaches.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class RiskProfilesDTO {
        ...
        return RiskProfilesDTO.builder()
                .profiles(List.of(
                        RiskProfile.builder()
                                ...
                                .description("Balanced approach: Equal priority across all factors with slight emphasis on bugs")
                                .budgetWeight(25)
                                .bugsWeight(30)
                                .scopeWeight(25)
                                .timeWeight(20)
    ...
    public static OrganizationSettingsDTO.RiskWeights getProfileWeights(String profileName) {
        return getDefaultProfiles().getProfiles().stream()
                ...
                .findFirst()
                .map(profile -> OrganizationSettingsDTO.RiskWeights.builder()
