...
/**
 * Preset risk calculation profiles for quick organization setup. Provides predefined weight
 * distributions optimized for different risk management approaches.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class RiskProfilesDTO {
  ...
  public static RiskProfilesDTO getDefaultProfiles() {
    return RiskProfilesDTO.builder()
        .profiles(
            List.of(
                RiskProfile.builder()
                    .name("balanced")
                ...
                RiskProfile.builder()
                    ...
                    .description(
                        "Conservative approach: Emphasizes budget control and bug prevention")
                    .budgetWeight(35)
                    .bugsWeight(35)
                    .scopeWeight(15)
                    .timeWeight(15)
                ...
                RiskProfile.builder()
                    ...
                    .description(
                        "Aggressive approach: Prioritizes scope delivery and timeline over budget")
                    .budgetWeight(15)
                    .bugsWeight(25)
                    .scopeWeight(35)
                    .timeWeight(25)
                ...
                RiskProfile.builder()
                    ...
                    .description(
                        "Quality-focused: Heavy emphasis on bug prevention and scope completion")
                    .budgetWeight(15)
                    .bugsWeight(40)
                    .scopeWeight(30)
                    .timeWeight(15)
                ...
                RiskProfile.builder()
                    .name("time_critical")
                    .displayName("Time-Critical")
                    .description("Time-critical: Optimized for deadline-driven projects")
                    .budgetWeight(20)
                    .bugsWeight(25)
                    .scopeWeight(20)
                    .timeWeight(35)
  ...
  public static OrganizationSettingsDTO.RiskWeights getProfileWeights(String profileName) {
    return getDefaultProfiles().getProfiles().stream()
        .filter(p -> p.getName().equalsIgnoreCase(profileName))
        .findFirst()
        .map(
            profile ->
                OrganizationSettingsDTO.RiskWeights.builder()
                    .budgetWeight(profile.getBudgetWeight())
                    .bugsWeight(profile.getBugsWeight())
