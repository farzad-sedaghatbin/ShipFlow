...
/**
 * Interface for vector store provider plugins.
 ...
 *   <li>Create and return a properly configured EmbeddingStore via {@link #createStore(VectorStoreProviderConfig)}</li>
...
public interface VectorStoreProvider {
     ...
     * Called automatically by the factory before creating the store.
     * 
     ...
     * Providers can override this to indicate their authentication requirements.
     * 
    ...
    /**
     * Indicates whether this provider requires a base URL.
     * Most remote vector stores require a URL.
     * 
