 ...
 * <ul>
 *   <li>Production deployments without local GPU</li>
 *   <li>Pay-per-use GPU compute</li>
 *   <li>Scaling AI workloads</li>
 * </ul>
 * 
 * <p>API Flow:
 * <ol>
 *   <li>POST /run - Submit job, returns {id: "..."}</li>
 *   <li>GET /status/{id} - Poll until status == "COMPLETED"</li>
 *   <li>Extract output from completed response</li>
 * </ol>
 */
@Component
@Slf4j
public class RunPodLLMProvider implements LLMProvider {
    ...
    public ChatLanguageModel createModel(LLMProviderConfig config) {
        ...
        log.info("Creating RunPod ChatLanguageModel - URL: {}, Model: {}", 
    ...
    static class RunPodChatModel implements ChatLanguageModel {
        ...
        RunPodChatModel(String baseUrl, String apiKey, String modelName,
