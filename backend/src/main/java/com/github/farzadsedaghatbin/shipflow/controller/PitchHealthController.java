...
/**
 * REST controller for pitch health summary endpoints.
 * Designed for non-technical stakeholders (PMs, founders).
 * 
...
public class PitchHealthController {
    ...
    @Operation(summary = "Get pitch health summary (fast)", 
               description = "Returns a simplified health snapshot for a single pitch using rule-based analysis")
    ...
    @Operation(summary = "Get pitch health summary with AI", 
    ...
    @Operation(summary = "Get cycle health summary (fast)", 
               description = "Returns aggregated health summary for an entire cycle using rule-based analysis")
    ...
    @Operation(summary = "Get cycle health summary with AI", 
    ...
    @Operation(summary = "Get all active cycles health (fast)", 
    ...
    @Operation(summary = "Get all active cycles health with AI", 
