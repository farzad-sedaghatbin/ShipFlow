...
/**
 * REST controller for pitch health summary endpoints. Designed for non-technical stakeholders (PMs,
 * founders).
 *
 * <p>Fast endpoints (default) use rule-based analysis for quick responses. AI-enhanced endpoints
 * use AI for deeper insights but are slower.
 */
@RestController
...
public class PitchHealthController {
  ...
  @Operation(
      summary = "Get pitch health summary (fast)",
      description =
          "Returns a simplified health snapshot for a single pitch using rule-based analysis")
  ...
  @Operation(
      summary = "Get pitch health summary with AI",
      description = "Returns health snapshot with AI-powered risk analysis (slower)")
  ...
  @Operation(
      summary = "Get cycle health summary (fast)",
      description =
          "Returns aggregated health summary for an entire cycle using rule-based analysis")
  ...
  @Operation(
      summary = "Get cycle health summary with AI",
      description = "Returns health summary with AI-powered risk analysis for all pitches (slower)")
  ...
  @Operation(
      summary = "Get all active cycles health (fast)",
      description = "Returns health summaries for all active cycles using rule-based analysis")
  ...
  @Operation(
      summary = "Get all active cycles health with AI",
      description = "Returns health summaries with AI-powered risk analysis (slower)")
