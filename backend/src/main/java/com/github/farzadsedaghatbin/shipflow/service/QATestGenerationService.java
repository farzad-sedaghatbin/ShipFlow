...
public class QATestGenerationService {
    ...
    public GenerateTestCasesResponse generateTestCases(GenerateTestCasesRequest request) {
        ...
        try {
            ...
            if (testCaseValidator != null && !suggestions.isEmpty()) {
                ...
                log.debug("Validation result - Valid: {}, Issues: {}", 
                        validation.getIsValid(), validation.getIssues().size());
        ...
        if (!meetings.isEmpty()) {
            ...
            for (Meeting meeting : meetings) {
                if (meeting.getNotes() != null && !meeting.getNotes().isEmpty()) {
                    context.append("- [").append(meeting.getType()).append("] ")
        ...
        for (String testCase : testCases) {
            ...
            try {
                ...
                if (title != null && !title.isEmpty()) {
                    suggestions.add(GenerateTestCasesResponse.TestCaseSuggestion.builder()
                            .title(title)
                            .description(description)
                            .preconditions(preconditions)
                            .steps(steps)
    ...
    private String extractField(String text, String fieldName) {
        ...
        String[] nextFields = {"TITLE:", "DESCRIPTION:", "PRECONDITIONS:", "STEPS:", "EXPECTED:", "TYPE:", "PRIORITY:", "TAGS:", "---END---"};
