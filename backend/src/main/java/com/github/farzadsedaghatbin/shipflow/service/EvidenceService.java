...
public class EvidenceService {
    ...
    public List<EvidenceDTO> getEvidencesByPitchId(Long pitchId) {
        return evidenceRepository.findByPitchId(pitchId)
                .stream()
                .map(this::toDTO)
                .collect(Collectors.toList());
    }
    ...
    public List<EvidenceDTO> getEvidencesByPersonId(Long personId) {
        return evidenceRepository.findByPersonId(personId)
                .stream()
                .map(this::toDTO)
                .collect(Collectors.toList());
    }
    ...
    private EvidenceDTO toDTO(Evidence evidence) {
        return EvidenceDTO.builder()
                ...
                .projectId(evidence.getPitch().getCycle() != null && evidence.getPitch().getCycle().getProject() != null ? evidence.getPitch().getCycle().getProject().getId() : null)
                .projectName(evidence.getPitch().getCycle() != null && evidence.getPitch().getCycle().getProject() != null ? evidence.getPitch().getCycle().getProject().getName() : null)
                .projectKey(evidence.getPitch().getCycle() != null && evidence.getPitch().getCycle().getProject() != null ? evidence.getPitch().getCycle().getProject().getProjectKey() : null)
